    ...
    <main class="main" id="top">
      <div class="container-fluid px-0">
        ...
        <div class="position-relative mt-4">
                <hr class="bg-200">
                <div class="divider-content-center">Garcon</div>
              </div>
          <div class="pb-5">
            ...
            <div class="row g-5">
              <div>
                <br/>
              <form method="post" action="/garcon/formulaire/traitement">
			      @csrf
                 <div class="row g-3 mb-3">
				  ...
				  <div class="col-md-6"><label class="form-label">adresse</label><input class="form-control form-icon-input" type="text" name="adresse" placeholder="adresse" required></div>
				  ...
				  <div class="col-md-6">
					...
					<select class="form-select" aria-label="Default select example" type="text" name="typetransport" placeholder="typetransport" required>
