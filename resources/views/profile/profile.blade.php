            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <li class="nav-item"><a class="nav-link active" href="/profile/client">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="/profile/domicile">
                  ...
                  <div class="card bg-white position-relative border-0">
                    <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                      ...
                      <ul class="nav d-flex flex-column mb-2 pb-1">
                        <li class="nav-item"><a class="nav-link px-3" href="{{ url('/profile') }}"><span class="me-2 text-900" data-feather="pie-chart"></span>profile</a></li>
                      </ul>
                    </div>
