      ...
      <div class="container-fluid px-0">
        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
              <div>
              <h1>liste des point de relais</h1>
              <hr/>
              <a href="" class="btn btn-primary mt-3">Ajouter</a>
<div class="mt-3">
<div id="tableExample2" data-list='{"valueNames":["nom","responsable","matricule","Houvert","adresse","numero","Hfermeture","journnée","typeprelais","actions"],"page":5,"pagination":true}'>
  <div class="table-responsive scrollbar">
    <table class="table table-bordered table-striped fs--1 mb-0">
      <thead class="bg-200 text-900">
        ...
        <th class="sort" data-sort="name">#</th>
          ...
          <th class="sort" data-sort="Houvert">Houvert</th>
          <th class="sort" data-sort="Hfermeture">Hfermeture</th>
          <th class="sort" data-sort="journnée ">journnée </th>
          <th class="sort" data-sort="typeprelais ">typeprelais </th>
          <th class="sort" data-sort="actions">actions</th>
        </tr>
      </thead>
      <tbody class="list">
      @foreach(  $pointrelais as $index =>$c)
    <tr>
    ...
    <td>{{ $c->typeprelais }}</td>
    <td>
    <a  data-bs-toggle="modal" data-bs-target="#editPointrelai{{ $c->id}}" ><span class="badge fs--1 bg-secondary">modifier</span></a>

    <a onclick="return confirm('voulez-vous vraiment supprimer?') " href="/admin/pointrelai/{{ $c->id}}/delete" ><span class="badge fs--1 bg-danger">supprimer</span></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter liste de point de relais</h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
      </div>
      <form action="/pointrelai/formulaire/traitement" method="post">
        @csrf
...
<div class="mb-3">
  <input class="form-control form-control" name="responsable" placeholder="responsable" required>
</div>
<div class="mb-3">
...
<div class="mb-3">
  <input class="form-control form-control" name="adresse" placeholder="adresse" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="Houvert" placeholder="Houvert" required>
</div>
<div class="mb-3">
  <input class="form-control form-control"name="Houvert" placeholder="Houvert" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="Hfermeture" placeholder="Hfermeture" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="journnée" placeholder="journnée" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="typeprelais" placeholder="typeprelais" required>
</div>
...
@foreach(  $pointrelais as $index =>$c)
 <!-- modal modifier-->
 <div class="modal fade" id="editPointrelai{{ $c->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">modifier liste de point de relais:<span class="text-primary">{{ $c->nom }}</span></h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
      </div>
      <form action="/admin/pointrelai/{id}/update" method="post">
        @csrf
      <div class="modal-body">
...
<div class="mb-3">
  <input class="form-control form-control" name="responsable" value="{{$c->responsable}}" placeholder="responsable" required>
</div>
<div class="mb-3">
...
<div class="mb-3">
  <input class="form-control form-control" name="adresse" value="{{$c->adresse}}" placeholder="adresse" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="Houvert" value="{{$c->Houvert}}" placeholder="Houvert" required>
</div>

<div class="mb-3">
  <input class="form-control form-control" name="Hfermeture" value="{{$c->Hfermeture}}" placeholder="Hfermeture" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="journnée" value="{{$c->journnée}}" placeholder="journnée" required>
</div>
<div class="mb-3">
  <input class="form-control form-control" name="typeprelais" value="{{$c->typeprelais}}" placeholder="journnée" required>
</div>
<input type="hidden" value="{{ $c->id}}" name="id_pointrelai">
