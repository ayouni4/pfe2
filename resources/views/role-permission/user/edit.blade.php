...
<html lang="en-US" dir="ltr">
  ...
  <div class="col-md-6">
    ...
    @error('name')<span class="badge fs--1 bg-danger"> {{$message}}</span> @enderror
  </div>

  <div class="col-md-6">
        <label for=""> email</label>
    <input class="form-control"  value="{{$user->email}}" name="email" type="text">
    @error('email')<span class="badge fs--1 bg-danger"> {{$message}}</span> @enderror
  ...
  <div class="col-md-6">
    ...
    @error('password')<span class="badge fs--1 bg-danger"> {{$message}}</span> @enderror

  </div>

  <div class="col-md-6">
        <label for=""> roles</label>
<select name="roles[]" class="form-select" aria-label="Default select example" multiple>
...
@error('role')<span class="badge fs--1 bg-danger"> {{$message}}</span> @enderror
