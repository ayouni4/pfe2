        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
             ...
             <h4>users</h4>
              <hr/>
              <a  href="{{url('users/create')}}" class="btn btn-primary mt-3">add user</a>
<div class="mt-3">

<div id="tableExample2" data-list='{"valueNames":["id","name","email","role","action"],"page":5,"pagination":true}'>
    ...
    <table class="table table-bordered table-striped fs--1 mb-0">
      <thead class="bg-200 text-900">
        <tr>
          ...
          <th class="sort" data-sort="action">role</th>
      ...
      @foreach($users as $index =>$user)
        ...
        <a  href="{{ url('users/'.$user->id.'/edit') }}"><span class="badge fs--1 bg-secondary">update</span></a>

        <a    href="{{ url('users/'.$user->id.'/delete') }}"><span class="badge fs--1 bg-danger">supprimer</span></a>
