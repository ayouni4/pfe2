        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
              ...
              <h1>role</h1>
              <hr/>
              <a  href="{{url('roles/create')}}" class="btn btn-primary mt-3">add role</a>
<div class="mt-3">

<div id="tableExample2" data-list='{"valueNames":["id","name","action"],"page":5,"pagination":true}'>
  <div class="table-responsive scrollbar">
    <table class="table table-bordered table-striped fs--1 mb-0">
      ...
      @foreach($roles as $index =>$role)
        ...
        <td>
        <a href="{{ url('roles/'.$role->id.'/give-permissions') }}"><span class="badge fs--1 bg-info">
        add/edit role permission</span>

    </a>

        <a href="{{ url('roles/'.$role->id.'/edit') }}"><span class="badge fs--1 bg-secondary">update</span></a>

        <a href="{{ url('roles/'.$role->id.'/delete') }}"><span class="badge fs--1 bg-danger">delete</span></a>
