        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
              ...
              <h1>permission</h1>
              <hr/>
              <a  href="{{url('permissions/create')}}" class="btn btn-primary mt-3">add permission</a>
<div class="mt-3">
  ...
  <div class="table-responsive scrollbar">
    <table class="table table-bordered table-striped fs--1 mb-0">
      ...
      @foreach($permissions as $index =>$permission)
        ...
        <td>
        <a href="{{ url('permissions/'.$permission->id.'/edit') }}"><span class="badge fs--1 bg-secondary">update</span></a>
        <a href="{{ url('permissions/'.$permission->id.'/delete') }}"><span class="badge fs--1 bg-secondary">delete</span></a>
